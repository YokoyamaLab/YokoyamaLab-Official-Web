...
### 博士1年
{% include profile.html type="start" %}
    {% include profile.html github="fhrzn" img="affandy.jpg" name="<span style='font-size: 0.8em;'>ファリザイン　アファンディ</span>" org="さすらいの旅人" %}
    {% include profile.html github="" img="" name="" org="さすらいの旅人" %}
{% include profile.html type="end" %}
...
{% include profile.html type="start" %}
    ...
    {% include profile.html github="aissur320" img="xiao.JEPG" name="肖 俊宇" org="さすらいの旅人" %}
