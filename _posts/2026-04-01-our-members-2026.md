...
### 博士1年
{% include profile.html type="start" %}
    {% include profile.html github="fhrzn" img="affandy.jpg" name="ファリザイン アファンディ" org="さすらいの旅人" %}
    {% include profile.html github="" img="satya.jfif" name="Satya Abdul Halim Bahtiar" org="研究を頑張ります。よろしくお願いします。" %}
{% include profile.html type="end" %}
...
{% include profile.html type="start" %}
    ...
    {% include profile.html github="aissur320" img="xiao.JPEG" name="肖 俊宇" org="さすらいの旅人" %}
...
{% include profile.html type="start" %}
    ...
    {% include profile.html github="takakuwa-mamada" img="takakuwa.jfif" name="高鍬 真輝" org="さすらいのトレーニー" %}
    {% include profile.html github="" img="matsumura.jpg" name="松村 歩空" org="さすらいの旅人" %}
    {% include profile.html github="lmh1048283020-netizen" img="li.jfif" name="李 敏赫" org="さすらいの旅人" %}
    {% include profile.html github="" img="default.jpg" name="葛西 璃久" org="さすらいの旅人" %}
{% include profile.html type="end" %}

### 学部4年
{% include profile.html type="start" %}
    {% include profile.html github="" img="default.jpg" name="定近 泰心" org="さすらいの旅人" %}
    {% include profile.html github="" img="default.jpg" name="東村 來武" org="さすらいの旅人" %}
    {% include profile.html github="" img="default.jpg" name="林 慶一郎" org="さすらいの旅人" %}
    {% include profile.html github="" img="default.jpg" name="清宮 冬惟" org="さすらいの旅人" %}
    {% include profile.html github="" img="default.jpg" name="斎藤 玲緒" org="さすらいの旅人" %}
{% include profile.html type="end" %}
