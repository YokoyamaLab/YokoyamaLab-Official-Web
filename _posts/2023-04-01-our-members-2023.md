...
### 博士1年
{% include profile.html type="start" %}
    {% include profile.html github="natsuki07" img="natasuki-fujiwara.jpg" name="藤原 夏姫" org="さすらいの旅人" %}
{% include profile.html type="end" %}
...
{% include profile.html type="start" %}
    ...
    {% include profile.html github="calpis01" img="dtakuro-ohashiefault.jpg" name="大橋 拓朗" org="さすらいの旅人" %}
